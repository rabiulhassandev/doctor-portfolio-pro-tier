<x-layouts.app
    ...
    <x-ui.page-hero
        ...
        title="Book an appointment"
        :lead="'Choose from the times ' . Str::before($doctor->name, ' ') . ' actually has free. You will get an email as soon as it is confirmed.'" />

    <section class="mx-auto max-w-6xl px-5 py-14 sm:px-8 sm:py-16">
    ...
    <section class="border-t border-line bg-paper-shade">
        <div class="mx-auto grid max-w-6xl gap-8 px-5 py-14 sm:px-8 sm:grid-cols-3">
            @foreach ([
                ...
                <div class="flex flex-col gap-2" data-reveal="{{ 80 * $index }}">
