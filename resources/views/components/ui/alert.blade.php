{{--
    ...
    needs their attention.
        ...
        <x-ui.alert tone="positive" title="Appointment confirmed">
...
@php
    $tones = [
        'positive' => [
            'box' => 'border-positive/25 bg-positive-soft text-positive',
            'icon' => 'M4.5 12.75l6 6 9-13.5',
        ],
        'caution' => [
            'box' => 'border-caution/25 bg-caution-soft text-caution',
            'icon' => 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z',
        ],
        'negative' => [
            'box' => 'border-negative/25 bg-negative-soft text-negative',
            'icon' => 'M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z',
        ],
        'info' => [
            'box' => 'border-brand/20 bg-brand-soft text-brand',
...
<div role="{{ $isProblem ? 'alert' : 'status' }}"
     {{ $attributes->class(['flex items-start gap-3 rounded-xl border px-4 py-3.5', $style['box']]) }}>

    <svg class="mt-0.5 size-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.75"
